...
export default function ChatSidebar({ symbol }: ChatSidebarProps) {
  ...
  return (
    <>
      ...
      {/* 사이드바 */}
      {isOpen && (
        <aside className="fixed lg:absolute right-0 top-0 h-full w-full sm:w-80 lg:w-96 bg-gray-900/95 backdrop-blur-sm border-l border-gray-800 transition-transform duration-300 z-40 flex flex-col">
